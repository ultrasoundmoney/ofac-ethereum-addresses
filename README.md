...
> [!IMPORTANT]
> The ultra sound relay no longer filters from this list. The relay's list is generated automatically from the latest OFAC SDN data and served live at:
>
...
1. Downloading the latest enhanced SDN list (`SDN_ENHANCED.ZIP`) from the OFAC API
2. Extracting 0x addresses from "Digital Currency Address" features in the enhanced XML
3. Deduplicating results and updating `data.csv` and README.md.
...
| MESRI, Behzad | 12 |
| OJEDA AVILES, Armando de Jesus | 5 |
| OKO DESIGN BUREAU | 1 |
| OLD VECTOR LLC | 1 |
